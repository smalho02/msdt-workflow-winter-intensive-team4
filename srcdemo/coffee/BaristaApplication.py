...
class BaristaApplication(RoleApplication):
    ...
    def __init__(self):
        ...
        self.register_sink_step("MakeOrder", self.prepare_drink_form_creator, name_fields=["sequence", "FirstName", "CoffeeType", "CoffeeSize"])
    ...
    def prepare_drink_form_creator(self, stepname, form):
        ...
        form.add_task_label(fields=["FirstName", "CoffeeType", "CoffeeSize"]) 
