...
class OrderTakerApplication(RoleApplication):
    ...
    def take_drink_order_form_creator(self, stepname, form):
        ...
        '''
        # !!! improve this text...
        form.add_html_label('<B>Enter new coffee order information:</B>')
        form.add_field(Type.SHORTSTRING, "FirstName", labeltext="First Name", initial="First");
        form.add_field(Type.SHORTSTRING, "CoffeeType", labeltext="Coffee Type", initial="Coffee");
        form.add_field(Type.SHORTSTRING, "CoffeeSize", labeltext="Coffee Size", initial="Size");
